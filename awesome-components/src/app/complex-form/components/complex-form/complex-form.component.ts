...
import { ComplexFormService } from '../../services/complex-fom.service';
import { confirmEqualValidator } from '../../validators/valid.validator';
...
export class ComplexFormComponent implements OnInit {
  ...
  getFormControlErrorText(ctrl: AbstractControl) {
    if (ctrl.hasError('required')) {
      ...
      return "C'ette adresse de contient pas le mot VALID";
    } else {
